...
import { CLAUDE_MODELS, CODEX_MODELS, CURSOR_MODELS, GEMINI_MODELS, MANGOCODE_MODELS } from '../../../../shared/modelConstants';
...
export function useChatProviderState({ selectedSession }: UseChatProviderStateArgs) {
  ...
  const [mangocodeModel, setMangocodeModel] = useState<string>(() => {
    return localStorage.getItem('mangocode-model') || MANGOCODE_MODELS.DEFAULT;
  });
